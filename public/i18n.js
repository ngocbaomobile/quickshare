...
const translations = {
  vi: {
    ...
    'files.btn_copy_image': '📋 이미지 복사',
    'files.btn_copy_image': '📋 复制图片',
    'files.btn_copy_image': '📋 画像コピー',
    'files.btn_copy_image': '📋 Copy Image',
    'files.btn_copy_image': '📋 이미지 복사',
    'files.btn_copy_image': '📋 复制图片',
    'files.btn_copy_image': '📋 画像コピー',
    'files.btn_copy_image': '📋 Copy Image',
    'files.btn_copy_image': '📋 Copy ảnh',
    ...
    'toast.copying_image': '이미지를 클립보드로 복사하는 중...',
    'toast.image_copied': '이미지가 클립보드에 복사되었습니다! 바로 붙여넣기 (Cmd+V) 가능',
    'toast.copy_image_hint': '화면의 이미지를 길게 눌러 "복사"를 선택하세요',
    'toast.copying_image': '正在将图片写入剪贴板...',
    'toast.image_copied': '图片已复制到剪贴板！可直接粘贴 (Cmd+V)',
    'toast.copy_image_hint': '请长按屏幕上的图片选择“复制”',
    'toast.copying_image': '画像をクリップボードに読み込み中...',
    'toast.image_copied': '画像をクリップボードにコピーしました（Cmd+Vで貼付可能）！',
    'toast.copy_image_hint': '画像を長押しして「コピー」を選択してください',
    'toast.copying_image': 'Loading image to clipboard...',
    'toast.image_copied': 'Image copied to clipboard! Ready to paste (Cmd+V)',
    'toast.copy_image_hint': 'Please long-press the image to select "Copy"',
    'toast.copying_image': '이미지를 클립보드로 복사하는 중...',
    'toast.image_copied': '이미지가 클립보드에 복사되었습니다! 바로 붙여넣기 (Cmd+V) 가능',
    'toast.copy_image_hint': '화면의 이미지를 길게 눌러 "복사"를 선택하세요',
    'toast.copying_image': '正在将图片写入剪贴板...',
    ...
    'toast.image_copied': 'Image copied to clipboard! Ready to paste (Cmd+V)',
    'toast.copy_image_hint': 'Please long-press the image to select "Copy"',
    'toast.copying_image': 'Đang nạp ảnh vào bộ nhớ tạm...',
    'toast.image_copied': 'Đã copy ảnh vào Clipboard! Có thể dán (Cmd+V) ngay',
    'toast.copy_image_hint': 'Hãy chạm giữ ảnh trên màn hình để chọn "Sao chép"',
    'toast.copy_manual_hint': '텍스트가 선택되었습니다. 화면의 "복사"를 탭하세요',
    'toast.copy_manual_hint': '已选中文字，请点击屏幕上的“复制”',
    'toast.copy_manual_hint': 'テキストを選択しました。画面の「コピー」をタップしてください',
    'toast.copy_manual_hint': 'Text selected, tap "Copy" on screen',
    'toast.copy_manual_hint': '텍스트가 선택되었습니다. 화면의 "복사"를 탭하세요',
    'toast.copy_manual_hint': '已选中文字，请点击屏幕上的“复制”',
    'toast.copy_manual_hint': 'テキストを選択しました。画面の「コピー」をタップしてください',
    'toast.copy_manual_hint': 'Text selected, tap "Copy" on screen',
    ...
    'toast.copy_manual_hint': 'テキストを選択しました。画面の「コピー」をタップしてください',
    'toast.copy_manual_hint': 'Text selected, tap "Copy" on screen',
    'toast.copy_manual_hint': 'Đã chọn văn bản, chạm "Sao chép" trên màn hình',
